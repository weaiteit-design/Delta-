...
export interface UserContext {
  ...
  techStack?: string[]; // e.g. ["React", "Python", "Figma"]
}
...
export interface VerifiedUpdate {
  ...
  date: string;
  url?: string;
  interests?: string[]; // e.g. ['creative', 'business', 'development']
}
...
export interface ToolSuggestion {
  ...
  domain?: string; // For favicon fallback
  tags?: string[]; // Optional tags for UI display
}
...
export interface UserStats {
  ...
  timeSavedMinutes?: number; // ROI Tracker
}
...
// New Learn Categories
export enum LearnCategory {
  Basics = "AI Basics",
  Writing = "Writing with AI",
  Research = "Research with AI",
  Thinking = "Thinking & Decision Making",
